...
// Clean manuscript (no outline notes). Compile: typst compile paper/paper.typ
...
With dryness as $D$, annual and monthly precipitation as $P_"ann"$ and $P_"mon"$, air temperature as $T$, and productivity as $G$, the annual rate $R$ of a cell is
$
R = [
  sigma(D; k_1, D_"low")
  dot s(D; k_2, D_"high")
